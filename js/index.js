...
function initSupabase() {
  // Implementação de initSupabase
}

function formatCPF(value) {
  // Implementação de formatCPF
}

function cleanCPF(value) {
  // Implementação de cleanCPF
}

function validateCPF(value) {
  // Implementação de validateCPF
}

function getStatusClass(status) {
  // Implementação de getStatusClass
}

function formatDateTime(date) {
  // Implementação de formatDateTime
}

function generatePDF(data, protocolo) {
  // Implementação de generatePDF
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    searchBtn.innerHTML = '<span class="spinner" style="width:1rem;height:1rem;border-width:2px;"></span> Buscando...'
